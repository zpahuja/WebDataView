...
for (var i = 0; i < globalBlocks.length; i++) {
    ...
    var hashVal = globalBlocks[i]['-style-background-color'].toString().concat(globalBlocks[i]['-style-color'], globalBlocks[i]['-style-font-family'], globalBlocks[i]['-style-font-kerning'], globalBlocks[i]['-style-font-size'], globalBlocks[i]['-style-color'], globalBlocks[i]['-att-classList']);
